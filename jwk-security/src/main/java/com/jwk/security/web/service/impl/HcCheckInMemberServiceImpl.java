...
import com.jwk.security.common.excel.ExcelExportReq;
import com.jwk.security.common.excel.ExcelHeadReq;
import com.jwk.security.common.excel.ExcelQueryConditionReq;
import com.jwk.security.enums.StatBusinessTypeReqE;
import com.jwk.security.web.service.ExcelExportService;
...
public class HcCheckInMemberServiceImpl implements ExcelExportService {
    ...
    public HSSFWorkbook export(ExcelExportReq condition) throws ServiceException {
        ...
        HSSFSheet sheet = wb.createSheet(this.generateSheetName(StatBusinessTypeReqE.getById(Integer.valueOf(condition.getBusinessType()))));
