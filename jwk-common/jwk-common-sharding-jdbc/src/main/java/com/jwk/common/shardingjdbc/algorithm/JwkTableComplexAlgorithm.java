...
/**
 * 通过复合分片键进行演示，覆盖Precise，Range，List三种类型的ShardingValue。 项目中应根据实际情况实现：
 * 1精确分片PreciseShardingAlgorithm、 2范围分片RangeShardingAlgorithm
 * 3复合分片ComplexKeysShardingAlgorithm 4非SQL解析分片HintShardingAlgorithm
 */
