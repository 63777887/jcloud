...
public final class PrometheusSentinelFeign {
	...
	public static PrometheusSentinelFeign.Builder builder() {
		return new PrometheusSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public PrometheusSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new PrometheusSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new PrometheusSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new PrometheusSentinelInvocationHandler(target, dispatch);
				}
