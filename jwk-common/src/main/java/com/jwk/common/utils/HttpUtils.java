...
public class HttpUtils {
  ...
  public static <T> T doGet(String url, String params, Class<T> clazz) throws ServiceException {
    ...
    try {
      ...
      ResponseEntity<String> resp = restTemplate
          .exchange(urlNameString, HttpMethod.GET, entity, String.class);
  ...
  public static <T> T doPostWithForm(String url, MultiValueMap<String, String> params,
  ...
  public static <T> List<T> doPostList(String url, String params, Class<T> clazz)
      throws ServiceException {
    JSONObject jo;
    try {
      //logger.info("url：{}", url);
      ...
      if (null != jo) {
        if ("0".equals(jo.getString("code"))) {
          if (null != clazz) {
            logger.info(
                "resultList:" + JSON.parseArray(jo.getJSONArray("data").toJSONString(), clazz));
  ...
  public static <T> List<T> doPostListHaveCookie(String url, String params, Class<T> clazz,
      String cookie) throws ServiceException {
    JSONObject jo;
    try {
      //logger.info("url：{}", url);
      //logger.info("params：{}", params);
   ...
   * @throws ServiceException
   */
  public static <T> List<T> doPostListByDC(String url, String params, Class<T> clazz)
      throws ServiceException {
    JSONObject jo;
    try {
      //logger.info("url：{}", url);
  ...
  public static <T> List<T> doPostPageList(String url, String params, Class<T> clazz)
      throws ServiceException {
    JSONObject jo;
    try {
  ...
  public static <T> T doPost(String url, String params, Class<T> clazz, String cookie)
      throws ServiceException {
    JSONObject jo;
    try {
      //logger.info("url：{}", url);
