...
public class HttpUtils {
    ...
    public static <T> T doGetHaveCookie(String url, String param, Class<T> clazz, String cookie) throws ServiceException {
        JSONObject jo;
        try {
            //logger.info("url：{}", url);
            //logger.info("params：{}", params);
    ...
    public static <T> T doPostWithForm(String url, MultiValueMap<String, String> params, Class<T> clazz) throws ServiceException {
        JSONObject jo;
        try {
            RestTemplate restTemplate = new RestTemplate();
    ...
    public static <T> T doPostHaveCookie(String url, String params, Class<T> clazz, String cookie) throws ServiceException {
        JSONObject jo;
        try {
            //logger.info("url：{}", url);
            //logger.info("params：{}", params);
    ...
    public static <T> List<T> doPostListHaveCookie(String url, String params, Class<T> clazz, String cookie) throws ServiceException {
        JSONObject jo;
        try {
            //logger.info("url：{}", url);
            //logger.info("params：{}", params);
    ...
    public static <T> List<T> doPostList(String url, String params, Class<T> clazz, String cookie) throws ServiceException {
        JSONObject jo;
        try {
            //logger.info("url：{}", url);
            //logger.info("params：{}", params);
