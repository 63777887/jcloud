...
public class JwkRocketMQCanalConnector implements CanalMQConnector {
  ...
  public JwkRocketMQCanalConnector(String nameServer, String topic, String groupName, String accessKey, String secretKey, Integer batchSize, boolean flatMessage, boolean enableMessageTrace, String customizedTraceTopic, String accessChannel, String namespace) {
  ...
  public JwkRocketMQCanalConnector(String nameServer, String topic, String groupName, String accessKey, String secretKey, Integer batchSize, boolean flatMessage, boolean enableMessageTrace, String customizedTraceTopic, String accessChannel) {
  ...
  public JwkRocketMQCanalConnector(String nameServer, String topic, String groupName, Integer batchSize, boolean flatMessage) {
  ...
  public JwkRocketMQCanalConnector(String nameServer, String topic, String groupName, String accessKey, String secretKey, Integer batchSize, boolean flatMessage) {
      ...
      if (data != null) {
        try {
          if (!this.flatMessage) {
            ...
            FlatMessage flatMessage = (FlatMessage)JSON.parseObject(data, FlatMessage.class, new Feature[0]);
