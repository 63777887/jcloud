...
public class ChromeDriveProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        Selectable xpath = page.getHtml().xpath("/html/body/div[2]/div/div/div[3]/ul/li/div[1]/div[2]/a/strong/text()");
        Selectable xpath1 = page.getHtml().$(".xy-list").nodes().get(1).xpath("//div[@class='a0']//strong/text()");
