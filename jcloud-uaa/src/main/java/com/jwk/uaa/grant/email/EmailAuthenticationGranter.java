...
public class EmailAuthenticationGranter
	...
	public EmailAuthenticationToken buildToken(Authentication clientPrincipal, Set<String> requestedScopes,
		...
		return new EmailAuthenticationToken(new AuthorizationGrantType(JwkOAuth2ParameterNames.EMAIL), clientPrincipal,
	...
	public void checkParams(HttpServletRequest request) {
		...
		if (!StringUtils.hasText(username)
				|| parameters.get(JwkOAuth2ParameterNames.EMAIL_PARAMETER_NAME).size() != 1) {
