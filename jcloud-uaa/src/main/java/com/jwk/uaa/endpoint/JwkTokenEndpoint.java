...
public class JwkTokenEndpoint {
	...
	public ModelAndView confirm(Principal principal, ModelAndView modelAndView,
		...
		Set<String> authorizedScopes = StrUtil.isNotBlank(scope)
				? new HashSet<>(StrUtil.split(scope, CharConstants.SPACE))
	...
	public R<Boolean> removeToken(@RequestParam("token") String token,
		...
		// 清除token记录
		upmsRemoteService.removeToken(RemoveTokenDto.builder().orgId(orgIg).userId(userId).accessToken(token)
