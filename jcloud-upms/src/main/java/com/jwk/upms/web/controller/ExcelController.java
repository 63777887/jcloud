...
public class ExcelController {
	...
	public R importExcel(@RequestParam("file") MultipartFile file,
			@RequestPart("businessType") String businessType) {
	...
	private static ExcelService getExcelService(String businessType) {
		...
		if (!optional.isPresent()) {
			...
			throw new ServiceException(String.valueOf(PrometheusExceptionCodeE.NoRegistryServiceInstance.getErrCode()),
					PrometheusExceptionCodeE.NoRegistryServiceInstance.getErrMsg());
		}
