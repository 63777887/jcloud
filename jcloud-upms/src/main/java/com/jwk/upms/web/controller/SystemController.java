...
public class SystemController {
	...
	@Inner(needFrom = false)
	public R removeToken(@RequestBody RemoveTokenDto removeTokenDto) {
		String recordAccessTokenKey = TokenUtil.buildRecordKey(OAuth2ParameterNames.ACCESS_TOKEN,
				removeTokenDto.getUserId());
		String recordRefreshTokenKey = TokenUtil.buildRecordKey(OAuth2ParameterNames.REFRESH_TOKEN,
				removeTokenDto.getUserId());
		Long orgId = removeTokenDto.getOrgId() == null || removeTokenDto.getOrgId() == 0L
				? SecurityUtils.getUser().getOrgId() : removeTokenDto.getOrgId();
	...
	private void removeTokenRecord(RemoveTokenDto removeTokenDto, String recordAccessTokenKey,
			String recordRefreshTokenKey) {
